...
const MilestoneList: React.FC = () => {
  ...
  const { data: response, isLoading } = useQuery({
    queryKey: ['templates', 'MILESTONES'],
    queryFn: () => apiGet<TemplateListResponse>(endPoints.TEMPLATE.GET_ALL, { type: 'MILESTONES', limit: '1000' }),
  });
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button variant="header" onClick={() => navigate('/dashboard/template-management/create?type=MILESTONES&moduleType=ENGAGEMENT')}>
